...
function Sidebar() {
  ...
  const isActive = (path) => location.pathname === path ? 'bg-blue-100' : '';
    ...
    <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
      <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul className="space-y-2 font-medium">
          <Link to='/dashboard'>
            <li className={`${isActive('/dashboard')} hover:bg-blue-100 rounded-lg`}>
          ...
          <Link to='/product'>
            <li className={`${isActive('/product')} hover:bg-blue-100 rounded-lg`}>
              <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
          ...
          <Link to='/payment'>
            <li className={`${isActive('/payment')} hover:bg-blue-100 rounded-lg`}>
              <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
          ...
          <Link to='/history'>
            <li className={`${isActive('/history')} hover:bg-blue-100 rounded-lg`}>
              <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
                <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
          ...
          <li onClick={handleLogout}>
                <a class="flex items-center hover:cursor-pointer p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-100 dark:hover:bg-gray-700 group">
