...
function Payment() {
    ...
    return (
        <>
            <Navbar />
            <Sidebar />
            <section className="min-h-screen py-8 pt-20 antialiased bg-white dark:bg-gray-900 md:py-16 md:ml-64">
                <div className="max-w-screen-xl px-4 mx-auto overflow-y-auto 2xl:px-0">
                    <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-200 sm:text-2xl">List Pembelian</h2>
                                        ...
                                        <div key={item.productId} className="mb-2 space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                            ...
                                            <div className="flex items-center justify-between space-x-8 md:order-3 md:justify-end">
                                                <div className="flex items-center">
                                                    ...
                                                    <input type="text" className="w-10 mx-2 text-center rounded" value={item.quantity} readOnly />
                                            ...
                                            <div className="flex-1 w-full min-w-0 md:order-2 md:max-w-md">
                                                <p className="text-base font-medium dark:text-gray-200">{item.nama}</p>
